...
T = TypeVar("T", bound="BaseMessageMetadata")


@_attrs_define
class BaseMessageMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        base_message_metadata = cls(
            usage=usage,
            retriever_resources=retriever_resources,
        )

        base_message_metadata.additional_properties = d
        return base_message_metadata
