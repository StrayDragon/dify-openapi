...
T = TypeVar("T", bound="UpdateDocumentByFileResponse200")


@_attrs_define
class UpdateDocumentByFileResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_document_by_file_response_200 = cls(
            document=document,
            batch=batch,
        )

        update_document_by_file_response_200.additional_properties = d
        return update_document_by_file_response_200
