...
T = TypeVar("T", bound="RetrieveDatasetBodyRetrievalModelRerankingModel")


@_attrs_define
class RetrieveDatasetBodyRetrievalModelRerankingModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        retrieve_dataset_body_retrieval_model_reranking_model = cls(
            reranking_provider_name=reranking_provider_name,
            reranking_model_name=reranking_model_name,
        )

        retrieve_dataset_body_retrieval_model_reranking_model.additional_properties = d
        return retrieve_dataset_body_retrieval_model_reranking_model
