...
T = TypeVar("T", bound="GetSegmentsResponse200")


@_attrs_define
class GetSegmentsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_segments_response_200 = cls(
            data=data,
            doc_form=doc_form,
        )

        get_segments_response_200.additional_properties = d
        return get_segments_response_200
