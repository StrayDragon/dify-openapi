...
T = TypeVar("T", bound="CreateDocumentByFileResponse200")


@_attrs_define
class CreateDocumentByFileResponse200:
    """
    Attributes:
        document (Union[Unset, Document]):
        batch (Union[Unset, str]): 文档批次号
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_document_by_file_response_200 = cls(
            document=document,
            batch=batch,
        )

        create_document_by_file_response_200.additional_properties = d
        return create_document_by_file_response_200
