...
if TYPE_CHECKING:
    from ..models.retrieve_dataset_response_200_records_item_segment_document import (
        RetrieveDatasetResponse200RecordsItemSegmentDocument,
    )


T = TypeVar("T", bound="RetrieveDatasetResponse200RecordsItemSegment")


@_attrs_define
class RetrieveDatasetResponse200RecordsItemSegment:
    """
    Attributes:
        id (Union[Unset, str]):
        ...
        document (Union[Unset, RetrieveDatasetResponse200RecordsItemSegmentDocument]):
    """
    ...
    document: Union[Unset, "RetrieveDatasetResponse200RecordsItemSegmentDocument"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_document, Unset):
            ...
            document = RetrieveDatasetResponse200RecordsItemSegmentDocument.from_dict(_document)

        retrieve_dataset_response_200_records_item_segment = cls(
            id=id,
            position=position,
        ...
        retrieve_dataset_response_200_records_item_segment.additional_properties = d
        return retrieve_dataset_response_200_records_item_segment
