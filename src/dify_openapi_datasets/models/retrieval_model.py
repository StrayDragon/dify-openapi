...
from ..models.retrieval_model_search_method import RetrievalModelSearchMethod, check_retrieval_model_search_method
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.retrieval_model_reranking_model import RetrievalModelRerankingModel


T = TypeVar("T", bound="RetrievalModel")
...
class RetrievalModel:
    """
    Attributes:
        search_method (Union[Unset, RetrievalModelSearchMethod]): 检索方法：
            - keyword_search: 关键字检索
            - semantic_search: 语义检索
            - full_text_search: 全文检索
            - hybrid_search: 混合检索
        reranking_enable (Union[Unset, bool]): 是否启用 Reranking，非必填，如果检索模式为 semantic_search 模式或者 hybrid_search 则传值
        reranking_model (Union[Unset, RetrievalModelRerankingModel]): Rerank 模型配置，非必填，如果启用了 reranking 则传值
        weights (Union[Unset, float]): 混合检索模式下语意检索的权重设置
        top_k (Union[Unset, int]): 返回结果数量，非必填
        score_threshold_enabled (Union[Unset, bool]): 是否开启 score 阈值
        score_threshold (Union[Unset, float]): Score 阈值
    """

    search_method: Union[Unset, RetrievalModelSearchMethod] = UNSET
    reranking_enable: Union[Unset, bool] = UNSET
    reranking_model: Union[Unset, "RetrievalModelRerankingModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_method: Union[Unset, RetrievalModelSearchMethod]
        if isinstance(_search_method, Unset):
            search_method = UNSET
        else:
            search_method = check_retrieval_model_search_method(_search_method)

        reranking_enable = d.pop("reranking_enable", UNSET)

        _reranking_model = d.pop("reranking_model", UNSET)
        reranking_model: Union[Unset, RetrievalModelRerankingModel]
        if isinstance(_reranking_model, Unset):
            reranking_model = UNSET
        else:
            reranking_model = RetrievalModelRerankingModel.from_dict(_reranking_model)
        ...
        retrieval_model.additional_properties = d
