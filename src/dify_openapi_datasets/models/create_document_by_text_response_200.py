...
T = TypeVar("T", bound="CreateDocumentByTextResponse200")


@_attrs_define
class CreateDocumentByTextResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_document_by_text_response_200 = cls(
            document=document,
            batch=batch,
        )

        create_document_by_text_response_200.additional_properties = d
        return create_document_by_text_response_200
