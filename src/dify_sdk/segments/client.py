...
class SegmentsClient:
    ...
    def get_segments(
        ...
        *,
        ...
        client.segments.get_segments(dataset_id='dataset_id', document_id='document_id', )
        """
        response = self._raw_client.get_segments(
            dataset_id,
            document_id,
            keyword=keyword,
            status=status,
    ...
    def create_segments(
        ...
        *,
        ...
        client = DifyApi(token="YOUR_TOKEN", )
        client.segments.create_segments(dataset_id='dataset_id', document_id='document_id', segments=[CreateSegmentsRequestSegmentsItem(content='content', )], )
        """
        response = self._raw_client.create_segments(
    ...
    def query_document_child_segments(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.segments.query_document_child_segments(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', )
        """
        response = self._raw_client.query_document_child_segments(
            dataset_id,
            document_id,
            segment_id,
            keyword=keyword,
    ...
    def create_document_child_segment(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.segments.create_document_child_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', content='content', )
        """
        response = self._raw_client.create_document_child_segment(
    ...
    def delete_document_child_segment(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.segments.delete_document_child_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', child_chunk_id='child_chunk_id', )
        """
        response = self._raw_client.delete_document_child_segment(
    ...
    def update_document_child_segment(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.segments.update_document_child_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', child_chunk_id='child_chunk_id', content='content', )
        """
        response = self._raw_client.update_document_child_segment(
    ...
    def update_segment(
        ...
        *,
        ...
        client = DifyApi(token="YOUR_TOKEN", )
        client.segments.update_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', segment=UpdateSegmentRequestSegment(), )
        """
        response = self._raw_client.update_segment(
    ...
    def delete_segment(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.segments.delete_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', )
        """
        response = self._raw_client.delete_segment(dataset_id, document_id, segment_id, request_options=request_options)
        return response.data
...
class AsyncSegmentsClient:
    ...
    async def get_segments(
        ...
        *,
        ...
        async def main() -> None:
            await client.segments.get_segments(dataset_id='dataset_id', document_id='document_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.get_segments(
            dataset_id,
            document_id,
            keyword=keyword,
            status=status,
    ...
    async def create_segments(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.segments.create_segments(dataset_id='dataset_id', document_id='document_id', segments=[CreateSegmentsRequestSegmentsItem(content='content', )], )
        asyncio.run(main())
        """
        response = await self._raw_client.create_segments(
            dataset_id, document_id, segments=segments, request_options=request_options
        )
        return response.data
    ...
    async def query_document_child_segments(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.segments.query_document_child_segments(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.query_document_child_segments(
            dataset_id,
            document_id,
            segment_id,
            keyword=keyword,
    ...
    async def create_document_child_segment(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.segments.create_document_child_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', content='content', )
        asyncio.run(main())
        """
        response = await self._raw_client.create_document_child_segment(
            dataset_id, document_id, segment_id, content=content, request_options=request_options
        )
        return response.data
    ...
    async def delete_document_child_segment(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.segments.delete_document_child_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', child_chunk_id='child_chunk_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.delete_document_child_segment(
            dataset_id, document_id, segment_id, child_chunk_id, request_options=request_options
        )
        return response.data
    ...
    async def update_document_child_segment(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.segments.update_document_child_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', child_chunk_id='child_chunk_id', content='content', )
        asyncio.run(main())
        """
        response = await self._raw_client.update_document_child_segment(
            dataset_id, document_id, segment_id, child_chunk_id, content=content, request_options=request_options
        )
        return response.data
    ...
    async def update_segment(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.segments.update_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', segment=UpdateSegmentRequestSegment(), )
        asyncio.run(main())
        """
        response = await self._raw_client.update_segment(
            dataset_id, document_id, segment_id, segment=segment, request_options=request_options
        )
        return response.data
    ...
    async def delete_segment(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.segments.delete_segment(dataset_id='dataset_id', document_id='document_id', segment_id='segment_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.delete_segment(
