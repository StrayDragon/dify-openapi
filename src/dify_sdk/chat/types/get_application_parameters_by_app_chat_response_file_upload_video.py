...
class GetApplicationParametersByAppChatResponseFileUploadVideo(UniversalBaseModel):
    """
    ...
    """
    Video quantity limit, default is 3
    """

    transfer_methods: typing.Optional[
        typing.List[GetApplicationParametersByAppChatResponseFileUploadVideoTransferMethodsItem]
