...
class GetApplicationParametersByAppChatResponseFileUploadAudio(UniversalBaseModel):
    """
    ...
    """
    Audio quantity limit, default is 3
    """

    transfer_methods: typing.Optional[
        typing.List[GetApplicationParametersByAppChatResponseFileUploadAudioTransferMethodsItem]
