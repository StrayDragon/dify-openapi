...
class GetApplicationParametersByAppChatResponseFileUploadCustom(UniversalBaseModel):
    """
    Custom settings
    """
    ...
    """
    Custom quantity limit, default is 3
    """

    transfer_methods: typing.Optional[
        typing.List[GetApplicationParametersByAppChatResponseFileUploadCustomTransferMethodsItem]
