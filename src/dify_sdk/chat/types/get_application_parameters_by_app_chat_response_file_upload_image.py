...
class GetApplicationParametersByAppChatResponseFileUploadImage(UniversalBaseModel):
    """
    ...
    """
    Image quantity limit, default is 3
    """

    transfer_methods: typing.Optional[
        typing.List[GetApplicationParametersByAppChatResponseFileUploadImageTransferMethodsItem]
