...
class ChatClient:
    ...
    def send_chat_message_by_app_chat(
        ...
        *,
        ...
        response = client.chat.chat.send_chat_message_by_app_chat(query='query', )
    ...
    def get_conversation_list_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_conversation_list_by_app_chat(user='user', )
        """
    ...
    def delete_conversation_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.delete_conversation_by_app_chat(conversation_id='conversation_id', user='user', )
        """
    ...
    def rename_conversation_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.rename_conversation_by_app_chat(conversation_id='conversation_id', user='user', )
        """
    ...
    def get_conversation_messages_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_conversation_messages_by_app_chat(conversation_id='conversation_id', user='user', )
        """
    ...
    def send_message_feedback_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.send_message_feedback_by_app_chat(message_id='message_id', rating='rating', user='user', )
        """
    ...
    def get_suggested_questions_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_suggested_questions_by_app_chat(message_id='message_id', user='user', )
        """
    ...
    def upload_file_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.upload_file_by_app_chat()
        """
    ...
    def get_application_info_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_application_info_by_app_chat()
        """
    ...
    def stop_chat_response_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.stop_chat_response_by_app_chat(task_id='task_id', user='user', )
        """
    ...
    def convert_audio_to_text_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.convert_audio_to_text_by_app_chat()
        """
    ...
    def get_application_parameters_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_application_parameters_by_app_chat()
        """
    ...
    def get_app_meta_info_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_app_meta_info_by_app_chat()
        """
    ...
    def get_annotations_list_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_annotations_list_by_app_chat()
        """
    ...
    def create_annotation_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.create_annotation_by_app_chat(question='question', answer='answer', )
        """
    ...
    def update_annotation_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.update_annotation_by_app_chat(annotation_id='annotation_id', question='question', answer='answer', )
        """
    ...
    def delete_annotation_by_app_chat(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.delete_annotation_by_app_chat(annotation_id='annotation_id', )
        """
    ...
    def configure_annotation_reply_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.configure_annotation_reply_by_app_chat(action="enable", )
        """
    ...
    def get_annotation_reply_status_by_app_chat(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.chat.chat.get_annotation_reply_status_by_app_chat(action="enable", job_id='job_id', )
        """
...
class AsyncChatClient:
    ...
    async def send_chat_message_by_app_chat(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.chat.chat.send_chat_message_by_app_chat(query='query', )
    ...
    async def get_conversation_list_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_conversation_list_by_app_chat(user='user', )
        asyncio.run(main())
        """
    ...
    async def delete_conversation_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.delete_conversation_by_app_chat(conversation_id='conversation_id', user='user', )
        asyncio.run(main())
        """
    ...
    async def rename_conversation_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.rename_conversation_by_app_chat(conversation_id='conversation_id', user='user', )
        asyncio.run(main())
        """
    ...
    async def get_conversation_messages_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_conversation_messages_by_app_chat(conversation_id='conversation_id', user='user', )
        asyncio.run(main())
        """
    ...
    async def send_message_feedback_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.send_message_feedback_by_app_chat(message_id='message_id', rating='rating', user='user', )
        asyncio.run(main())
        """
    ...
    async def get_suggested_questions_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_suggested_questions_by_app_chat(message_id='message_id', user='user', )
        asyncio.run(main())
        """
    ...
    async def upload_file_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.upload_file_by_app_chat()
        asyncio.run(main())
        """
    ...
    async def get_application_info_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_application_info_by_app_chat()
        asyncio.run(main())
        """
    ...
    async def stop_chat_response_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.stop_chat_response_by_app_chat(task_id='task_id', user='user', )
        asyncio.run(main())
        """
    ...
    async def convert_audio_to_text_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.convert_audio_to_text_by_app_chat()
        asyncio.run(main())
        """
    ...
    async def get_application_parameters_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_application_parameters_by_app_chat()
        asyncio.run(main())
        """
    ...
    async def get_app_meta_info_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_app_meta_info_by_app_chat()
        asyncio.run(main())
        """
    ...
    async def get_annotations_list_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_annotations_list_by_app_chat()
        asyncio.run(main())
        """
    ...
    async def create_annotation_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.create_annotation_by_app_chat(question='question', answer='answer', )
        asyncio.run(main())
        """
    ...
    async def update_annotation_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.update_annotation_by_app_chat(annotation_id='annotation_id', question='question', answer='answer', )
        asyncio.run(main())
        """
    ...
    async def delete_annotation_by_app_chat(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.delete_annotation_by_app_chat(annotation_id='annotation_id', )
        asyncio.run(main())
        """
    ...
    async def configure_annotation_reply_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.configure_annotation_reply_by_app_chat(action="enable", )
        asyncio.run(main())
        """
    ...
    async def get_annotation_reply_status_by_app_chat(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.chat.chat.get_annotation_reply_status_by_app_chat(action="enable", job_id='job_id', )
        asyncio.run(main())
        """
