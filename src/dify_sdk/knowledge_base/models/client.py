...
class ModelsClient:
    ...
    def get_embedding_models(
        ...
        client.knowledge_base.models.get_embedding_models()
        """
        _response = self._raw_client.get_embedding_models(request_options=request_options)
...
class AsyncModelsClient:
    ...
    async def get_embedding_models(
        ...
        async def main() -> None:
            await client.knowledge_base.models.get_embedding_models()
        asyncio.run(main())
        """
        _response = await self._raw_client.get_embedding_models(request_options=request_options)
        return _response.data
