...
class DatasetsClient:
    ...
    def get_dataset_list(
        ...
        *,
        ...
        client.knowledge_base.datasets.get_dataset_list()
        """
        _response = self._raw_client.get_dataset_list(page=page, limit=limit, request_options=request_options)
    ...
    def create_empty_dataset(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.knowledge_base.datasets.create_empty_dataset(name='name', )
        """
        _response = self._raw_client.create_empty_dataset(
            name=name,
    ...
    def view_knowledge_base_details(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.knowledge_base.datasets.view_knowledge_base_details(dataset_id='dataset_id', )
        """
        _response = self._raw_client.view_knowledge_base_details(dataset_id, request_options=request_options)
        return _response.data
    ...
    def delete_dataset(self, dataset_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.knowledge_base.datasets.delete_dataset(dataset_id='dataset_id', )
        """
    ...
    def update_knowledge_base_details(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.knowledge_base.datasets.update_knowledge_base_details(dataset_id='dataset_id', )
        """
        _response = self._raw_client.update_knowledge_base_details(
            dataset_id,
            name=name,
            indexing_technique=indexing_technique,
            permission=permission,
    ...
    def retrieve_dataset(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.knowledge_base.datasets.retrieve_dataset(dataset_id='dataset_id', query='query', )
        """
...
class AsyncDatasetsClient:
    ...
    async def get_dataset_list(
        ...
        *,
        ...
        async def main() -> None:
            await client.knowledge_base.datasets.get_dataset_list()
        asyncio.run(main())
        """
        _response = await self._raw_client.get_dataset_list(page=page, limit=limit, request_options=request_options)
        return _response.data
    ...
    async def create_empty_dataset(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.knowledge_base.datasets.create_empty_dataset(name='name', )
        asyncio.run(main())
        """
        _response = await self._raw_client.create_empty_dataset(
            name=name,
            description=description,
            indexing_technique=indexing_technique,
            permission=permission,
    ...
    async def view_knowledge_base_details(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.knowledge_base.datasets.view_knowledge_base_details(dataset_id='dataset_id', )
        asyncio.run(main())
        """
        _response = await self._raw_client.view_knowledge_base_details(dataset_id, request_options=request_options)
        return _response.data
    ...
    async def delete_dataset(self, dataset_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.knowledge_base.datasets.delete_dataset(dataset_id='dataset_id', )
        asyncio.run(main())
        """
    ...
    async def update_knowledge_base_details(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.knowledge_base.datasets.update_knowledge_base_details(dataset_id='dataset_id', )
        asyncio.run(main())
        """
        _response = await self._raw_client.update_knowledge_base_details(
            dataset_id,
            name=name,
            indexing_technique=indexing_technique,
            permission=permission,
    ...
    async def retrieve_dataset(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.knowledge_base.datasets.retrieve_dataset(dataset_id='dataset_id', query='query', )
        asyncio.run(main())
        """
