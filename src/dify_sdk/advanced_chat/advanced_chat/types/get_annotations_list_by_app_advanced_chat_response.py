...
class GetAnnotationsListByAppAdvancedChatResponse(UniversalBaseModel):
    data: typing.Optional[typing.List[GetAnnotationsListByAppAdvancedChatResponseDataItem]] = None
