...
class GetApplicationParametersByAppAdvancedChatResponseTextToSpeech(UniversalBaseModel):
    """
    Text to speech
    """
    ...
    auto_play: typing_extensions.Annotated[
        typing.Optional[GetApplicationParametersByAppAdvancedChatResponseTextToSpeechAutoPlay],
        FieldMetadata(alias="autoPlay"),
