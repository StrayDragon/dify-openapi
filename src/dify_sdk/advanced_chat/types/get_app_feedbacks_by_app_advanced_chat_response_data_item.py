...
class GetAppFeedbacksByAppAdvancedChatResponseDataItem(UniversalBaseModel):
    ...
    rating: typing.Optional[GetAppFeedbacksByAppAdvancedChatResponseDataItemRating] = pydantic.Field(default=None)
    """
    Rating type
    """
