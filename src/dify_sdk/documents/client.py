...
class DocumentsClient:
    ...
    def create_document_by_text(
        ...
        *,
        ...
        from dify import ProcessRule
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.create_document_by_text(dataset_id='dataset_id', name='name', text='text', indexing_technique="high_quality", process_rule=ProcessRule(mode="automatic", ), )
        """
        response = self._raw_client.create_document_by_text(
            dataset_id,
            name=name,
            text=text,
    ...
    def create_document_by_file(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.create_document_by_file(dataset_id='dataset_id', )
        """
        response = self._raw_client.create_document_by_file(
    ...
    def update_document_by_text(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.update_document_by_text(dataset_id='dataset_id', document_id='document_id', )
        """
        response = self._raw_client.update_document_by_text(
            dataset_id,
            document_id,
            name=name,
            text=text,
    ...
    def update_document_by_file(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.update_document_by_file(dataset_id='dataset_id', document_id='document_id', )
        """
        response = self._raw_client.update_document_by_file(
    ...
    def get_document_indexing_status(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.get_document_indexing_status(dataset_id='dataset_id', batch='batch', )
        """
        response = self._raw_client.get_document_indexing_status(dataset_id, batch, request_options=request_options)
        return response.data
    ...
    def get_document_list(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.get_document_list(dataset_id='dataset_id', )
        """
        response = self._raw_client.get_document_list(
    ...
    def delete_document(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.delete_document(dataset_id='dataset_id', document_id='document_id', )
        """
        response = self._raw_client.delete_document(dataset_id, document_id, request_options=request_options)
        return response.data
    ...
    def get_upload_file(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.documents.get_upload_file(dataset_id='dataset_id', document_id='document_id', )
        """
        response = self._raw_client.get_upload_file(dataset_id, document_id, request_options=request_options)
        return response.data
...
class AsyncDocumentsClient:
    ...
    async def create_document_by_text(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.create_document_by_text(dataset_id='dataset_id', name='name', text='text', indexing_technique="high_quality", process_rule=ProcessRule(mode="automatic", ), )
        asyncio.run(main())
        """
        response = await self._raw_client.create_document_by_text(
            dataset_id,
            name=name,
            text=text,
            indexing_technique=indexing_technique,
    ...
    async def create_document_by_file(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.documents.create_document_by_file(dataset_id='dataset_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.create_document_by_file(
            dataset_id, file=file, data=data, request_options=request_options
        )
        return response.data
    ...
    async def update_document_by_text(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.documents.update_document_by_text(dataset_id='dataset_id', document_id='document_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.update_document_by_text(
            dataset_id,
            document_id,
            name=name,
            text=text,
    ...
    async def update_document_by_file(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.documents.update_document_by_file(dataset_id='dataset_id', document_id='document_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.update_document_by_file(
            dataset_id, document_id, file=file, name=name, process_rule=process_rule, request_options=request_options
        )
        return response.data
    ...
    async def get_document_indexing_status(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.documents.get_document_indexing_status(dataset_id='dataset_id', batch='batch', )
        asyncio.run(main())
        """
        response = await self._raw_client.get_document_indexing_status(
    ...
    async def get_document_list(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.documents.get_document_list(dataset_id='dataset_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.get_document_list(
            dataset_id, keyword=keyword, page=page, limit=limit, request_options=request_options
        )
        return response.data
    ...
    async def delete_document(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.documents.delete_document(dataset_id='dataset_id', document_id='document_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.delete_document(dataset_id, document_id, request_options=request_options)
        return response.data
    ...
    async def get_upload_file(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.documents.get_upload_file(dataset_id='dataset_id', document_id='document_id', )
        asyncio.run(main())
        """
        response = await self._raw_client.get_upload_file(dataset_id, document_id, request_options=request_options)
        return response.data
