...
class WorkflowClient:
    ...
    def run_workflow(
        ...
        *,
        ...
        response = client.workflow.workflow.run_workflow(inputs={'key': 'value'
    ...
    def get_workflow_execution_status(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.workflow.workflow.get_workflow_execution_status(workflow_run_id='workflow_run_id', )
        """
    ...
    def stop_workflow(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.workflow.workflow.stop_workflow(task_id='task_id', user='user', )
        """
    ...
    def get_workflow_logs(
        ...
        *,
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.workflow.workflow.get_workflow_logs()
        """
    ...
    def upload_file(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.workflow.workflow.upload_file(user='user', )
        """
    ...
    def get_app_info(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetAppInfoResponse:
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.workflow.workflow.get_app_info()
        """
    ...
    def get_app_parameters(
        ...
        from dify import DifyApi
        client = DifyApi(token="YOUR_TOKEN", )
        client.workflow.workflow.get_app_parameters()
        """
...
class AsyncWorkflowClient:
    ...
    async def run_workflow(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.workflow.workflow.run_workflow(inputs={'key': 'value'
            }, response_mode="streaming", user='user', )
    ...
    async def get_workflow_execution_status(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.workflow.workflow.get_workflow_execution_status(workflow_run_id='workflow_run_id', )
        asyncio.run(main())
        """
    ...
    async def stop_workflow(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.workflow.workflow.stop_workflow(task_id='task_id', user='user', )
        asyncio.run(main())
        """
    ...
    async def get_workflow_logs(
        ...
        *,
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.workflow.workflow.get_workflow_logs()
        asyncio.run(main())
        """
    ...
    async def upload_file(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.workflow.workflow.upload_file(user='user', )
        asyncio.run(main())
        """
    ...
    async def get_app_info(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetAppInfoResponse:
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.workflow.workflow.get_app_info()
        asyncio.run(main())
        """
    ...
    async def get_app_parameters(
        ...
        client = AsyncDifyApi(token="YOUR_TOKEN", )
        async def main() -> None:
            await client.workflow.workflow.get_app_parameters()
        asyncio.run(main())
        """
