...
class ChunkWorkflowMessageData(UniversalBaseModel):
    """
    Event related data
    """
    ...
    status: typing.Optional[ChunkWorkflowMessageDataStatus] = pydantic.Field(default=None)
    """
    Execution status
    """
    ...
    execution_metadata: typing.Optional[ChunkWorkflowMessageDataExecutionMetadata] = pydantic.Field(default=None)
    """
    Metadata
    """
