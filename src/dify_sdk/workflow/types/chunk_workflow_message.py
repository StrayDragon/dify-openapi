...
class ChunkWorkflowMessage(UniversalBaseModel):
    event: typing.Optional[ChunkWorkflowMessageEvent] = pydantic.Field(default=None)
    """
    ...
    data: typing.Optional[ChunkWorkflowMessageData] = pydantic.Field(default=None)
    """
    Event related data
    """

    metadata: typing.Optional[ChunkWorkflowMessageMetadata] = None
