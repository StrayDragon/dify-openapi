...
class GetAppParametersResponseFileUploadCustom(UniversalBaseModel):
    """
    Custom settings
    """
    ...
    transfer_methods: typing.Optional[typing.List[GetAppParametersResponseFileUploadCustomTransferMethodsItem]] = (
