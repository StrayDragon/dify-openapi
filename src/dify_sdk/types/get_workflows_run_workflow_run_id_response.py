...
class GetWorkflowsRunWorkflowRunIdResponse(UniversalBaseModel):
    ...
    status: typing.Optional[GetWorkflowsRunWorkflowRunIdResponseStatus] = pydantic.Field(default=None)
    """
    Execution status
    """
