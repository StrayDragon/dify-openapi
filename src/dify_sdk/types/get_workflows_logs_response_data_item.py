...
class GetWorkflowsLogsResponseDataItem(UniversalBaseModel):
    id: typing.Optional[str] = pydantic.Field(default=None)
    """
    Identifier
    """

    workflow_run: typing.Optional[GetWorkflowsLogsResponseDataItemWorkflowRun] = pydantic.Field(default=None)
    """
    ...
    created_by_end_user: typing.Optional[GetWorkflowsLogsResponseDataItemCreatedByEndUser] = pydantic.Field(
        default=None
    )
    """
    User
