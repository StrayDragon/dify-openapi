...
class GetWorkflowsLogsResponseDataItemWorkflowRun(UniversalBaseModel):
    """
    ...
    status: typing.Optional[GetWorkflowsLogsResponseDataItemWorkflowRunStatus] = pydantic.Field(default=None)
    """
    Execution status
    """
