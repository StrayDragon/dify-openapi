...
class GetApplicationParametersByAppGenerationResponseFileUploadVideo(UniversalBaseModel):
    """
    Video settings
    ...
    transfer_methods: typing.Optional[
        typing.List[GetApplicationParametersByAppGenerationResponseFileUploadVideoTransferMethodsItem]
